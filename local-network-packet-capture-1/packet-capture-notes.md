...
Selected an HTTP GET request packet and reviewed the Packet Details pane to inspect the request line, headers, and host information.
Right-clicked the packet and used Follow -> HTTP Stream to reassemble the full plaintext request and response.
