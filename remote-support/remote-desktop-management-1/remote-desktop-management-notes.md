...
![Anydesk open session pops up on client device](https://github.com/KhalidASC20/security-plus-labs/blob/main/remote-support/remote-desktop-management-1/anydesk-open-session.png?raw=true)
Notes window showing Printer disabled when trying to print
![Notes window showing Printer disabled when trying to print](https://github.com/KhalidASC20/security-plus-labs/blob/main/remote-support/remote-desktop-management-1/printer-disabled-during-attempt.png?raw=true)
Command Prompt output of whoami and whoami /groups
![Command Prompt output of `whoami` and `whoami /groups`](https://github.com/KhalidASC20/security-plus-labs/blob/main/remote-support/remote-desktop-management-1/whoami-command-lines.png?raw=true)
Services window showing Print Spooler status as running
![Services window showing Print Spooler status as running](https://github.com/KhalidASC20/security-plus-labs/blob/main/remote-support/remote-desktop-management-1/print-spool-running.png?raw=true)
